...
- Researchers and educators visualizing ratio networks and interval spaces.
- Designers producing tunings, charts, or printable lattice diagrams.

## Typical workflows
- Build a lattice from ratios → audition intervals → export a diagram.
- Create a custom tuning → save snapshots → switch during playback.
- Analyze relationships between nodes → label key intervals → share a preset.
